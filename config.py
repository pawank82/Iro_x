...
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6215916401").split())
)
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/pawank82/Iro_x")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/478593a0d6b53fda8be8f.jpg")
